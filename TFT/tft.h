...
public:
	...
	void line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, \
		uint16_t c);
	inline void line(const class point p1, const class point p2, \
		uint16_t c);
	...
	void rectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h, \
		uint16_t c);
	inline void triangle(const class point p1, const class point p2, \
		const class point p3, uint16_t c);
...
inline void tfthw::line(const class point p1, const class point p2, \
	uint16_t c)
{
	line(p1.x(), p1.y(), p2.x(), p2.y(), c);
}

inline void tfthw::triangle(const class point p1, const class point p2, \
	const class point p3, uint16_t c)
{
	line(p1, p2, c);
	line(p2, p3, c);
